...
public class Conexion {
    ...
    public Conexion(String user, String contraseña, String host, String codificacion, Short tiempoEspera,
    ...
    public static class ConexionBuilder{
        ...
        public ConexionBuilder build(){
            return new ConexionBuilder(user, host, contraseña, codificacion, tiempoEspera, reintentos, SSL, port , baseDatos);
        }
